...
Scoring (phase 5): `scoring_summary.md` (exclusions, tiers, component distributions, Top-50 composition, ties at the cutoff, sensitivity; counts only — the lead list stays in data/interim/scored.csv).
